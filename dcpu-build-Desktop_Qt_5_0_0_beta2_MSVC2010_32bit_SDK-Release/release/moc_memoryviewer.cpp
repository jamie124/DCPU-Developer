...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MemoryViewer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 32, 7)
    ...
    "MemoryViewer\0setScrollbarValue\0\0animate\0"
};
...
void MemoryViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MemoryViewer::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MemoryViewer::setScrollbarValue)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject MemoryViewer::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_MemoryViewer.data,
      qt_meta_data_MemoryViewer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MemoryViewer.stringdata))
...
// SIGNAL 0
void MemoryViewer::setScrollbarValue(int _t1)
{
