...
/**
  ...
  * widgets you find in standard find/replace dialogs, and it acts on a Editor.
  *
  * \image html Screenshot-FindReplace.png
  *
  * You need to set the Editor explicitly, using the method setTextEdit(Editor *textEdit).
  *
  * For instance
  * \code
...
public:
    ...
    /**
      ...
      * @param textEdit_
      */
    void setTextEdit(Editor *textEdit_);
